...
<body>
	...
	<main
		...
		<section class="flex w-[30rem] flex-col space-y-10">
			...
			<div
				class="w-full transform border-b-2 bg-transparent text-lg duration-300 focus-within:border-indigo-500">
				<input type="email" placeholder="user_email"
					class="w-full border-none bg-transparent outline-none placeholder:italic focus:outline-none" />
			</div>

			<div
				class="w-full transform border-b-2 bg-black text-lg duration-300 focus-within:border-indigo-500">
				<select name="pays" class="bg-black">
			...
			<p class="text-center text-lg">
				No account? <a href="#"
					class="font-medium text-indigo-500 underline-offset-4 hover:underline">Create
					One</a>
			</p>
		</section>
		</form>
